...
function scoreMessage(scorePercent: number): string {
  if (scorePercent === 100) return "Sempurna! Hebat sekali, Zayyan! 🎉";
  ...
  return (
    <div className="flex flex-1 flex-col items-center bg-zinc-50 px-4 py-10 dark:bg-black sm:px-8">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 text-center shadow-sm dark:bg-zinc-900">
        <p className="text-lg font-semibold text-zinc-700 dark:text-zinc-300">{scoreMessage(attempt.scorePercent)}</p>
